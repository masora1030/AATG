...
def get_prediction(request: Request, original_title: str = Form(...), ero_level: int = Form(...)):
    ...
    tweet_url = f"https://twitter.com/share?text={original_title}%0a↓%0a↓%0a↓%0a{av_title}%0a%23AutoAvTitleGenerator%0ahttps://aatglove.herokuapp.com%0a&count=none&lang=ja"
